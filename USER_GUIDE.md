...
### 4. View & Edit the Code
Curious how it works or want to make a quick tweak?
1.  **Switch to Editor**: Click the **"Editor"** button in the top bar of the simulation window.
2.  **Edit Live**: You'll see the full HTML/JS code. Type anywhere to change parameters, colors, or logic.
3.  **Instant Preview**: Switch back to **"Preview"** (or watch it update if supported) to see your changes immediately effective.
4.  **Reset**: If you break something, hit the **Reset** button to restore the original AI-generated code.
